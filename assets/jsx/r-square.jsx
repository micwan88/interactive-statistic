/**
 * RSquaredVisualization.jsx
 * ---------------------------------------------------------------
 * Interactive visualization decomposing total variance into
 * explained (SSR) and unexplained (SSE) parts.
 *
 *   SST = Σ(yᵢ − ȳ)²   (total)
 ...
 *
 * Usage:
 *   import RSquaredVisualization from './RSquaredVisualization';
 *
 *   function App() {
 *     return <RSquaredVisualization />;
 *   }
 *
 * Requirements: React 16.8+ (uses hooks). No external dependencies.
 * ---------------------------------------------------------------
 */
...
const COLORS = {
  point: '#185FA5',
  regLine: '#185FA5',
  meanLine: 'rgba(0,0,0,0.4)',
  total: 'rgba(0,0,0,0.45)',
  residual: '#D85A30',
  explained: '#0F6E56',
  ...
  return (
    <button
      ...
      style={{
        ...
        border: `0.5px solid ${active ? COLORS.borderStrong : COLORS.border}`,
...
// ---- Main component -------------------------------------------
export default function RSquaredVisualization() {
